...
export default function dataturksReducer(state = dtInitialState, action = {}) {
  switch (action.type) {
    case TOGGLE_MENU:
      return {
        ...state,
    ...
    case GET_PROJECT_ID_SUCCESS:
      localStorage.setItem('currentProject', action.result.body.response)
      return {
        ...state,
        loading: false,
    ...
    case '@@router/LOCATION_CHANGE':
      ...
      if (action.payload.pathname === '/projects/create') {
        return {
          ...state,
          menuHidden,
          currentPathProject: pathSplits[3],
          currentPathOrg: pathSplits[2],
          locationPath: action.payload.pathname,
          currentProject: null,
          projectCreated: false,
          projectDetails: null,
        }
