    ...
    for (let index = 0; index < projects.length; index++) {
      ...
      arrs.push(
        <Card raised blue key={index} style={{ width: '35%', marginLeft: '5%', marginRight: '5%', marginBottom: '5%' }}>
          <Card.Content extra style={{ cursor: 'pointer' }} onClick={this.openStats.bind(this, 'stats', projects[index].projectDetails.orgName, projects[index].projectDetails.name)}>
            ...
            <Card.Meta className="marginTop">
              {projects[index].projectDetails.visibility_type &&
                <Label size="mini" inverted style={{ width: '20%', background: '#a1bccc', color: 'white' }}>
                  {projects[index].projectDetails.visibility_type} </Label>
              }
              <br />
              <span className="date">
            ...
            <Card.Description>
              <Progress style={{ marginBottom: '1em', fontSize: '0.75rem' }}
                precision={0} color="olive" indicating progress
                percent={projects[index].projectDetails.totalHits === 0 ? 0 : (projects[index].projectDetails.totalHitsDone * 100) / projects[index].projectDetails.totalHits} />
          ...
          <Card.Content extra>
            ...
            {!tagButtonHidden &&
              <Button color="teal" className="pull-right" name="posT1"
                size="mini"
                onClick={this.openStats.bind(this, 'tag', projects[index].projectDetails.orgName, projects[index].projectDetails.name)}>
